...
internal sealed class MenuItemEditDialog : Form
{
    ...
    public MenuItemEditDialog(string title, string name, string cmd, string terminal, bool keepWindow)
    {
        ...
        var okBtn = new Button { Text = "确定", Bounds = new Rectangle(180, 148, 80, 30), DialogResult = DialogResult.OK };
        var cancelBtn = new Button { Text = "取消", Bounds = new Rectangle(270, 148, 80, 30), DialogResult = DialogResult.Cancel };
